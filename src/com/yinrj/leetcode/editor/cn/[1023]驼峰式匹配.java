package com.yinrj.leetcode.editor.cn;//如果我们可以将小写字母插入模式串 pattern 得到待查询项 query，那么待查询项与给定模式串匹配。（我们可以在任何位置插入每个字符，也可以插入 0
//个字符。） 
//
...
// 
//
// Related Topics 字典树 双指针 字符串 字符串匹配 👍 109 👎 0
...
class Solution1023 {
    ...
    private static boolean check(String query, String pattern) {
        int i = 0;
